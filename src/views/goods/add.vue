...
export default {
    ...
    methods: {
        ...
        beforeTabLeave: function(activeName, oldActiveName) {
            ...
            // console.log('即将要到达的标签页名字是:' + activeName);
            // return false;
        ...
        tabClicked: async function() {
            ...
            if (this.activeIndex === '1') {
                const { data: res } = await this.$require.get(`categories/${this.cateId}/attributes`, { params: { sel: 'many' }});
                ...
                const { data: res } = await this.$require.get(`categories/${this.cateId}/attributes`, { params: { sel: 'only' }});
        ...
        add: function() {
            ...
            this.$refs.addFormRef.validate(async valid => {
                ...
                // 执行添加的业务逻辑
                // 级联选择器 v-model 双向绑定了 goods_cat 所以不能由数组变为字符串
